...
export function EmptyState({ icon, title, description, action, className }: EmptyStateProps) {
  return (
    <SurfaceCard tone="soft" padding="lg" className={cn('text-center', className)}>
      {icon ? <div className="mx-auto mb-4 grid h-14 w-14 place-items-center rounded-[1.25rem] bg-white text-[#336886] shadow-[0_14px_28px_-24px_rgba(15,23,42,0.30)] ring-1 ring-[#d7e7ef]">{icon}</div> : null}
