    ...
    >
      ...
      <div className="relative flex w-full max-w-[360px] flex-col items-center">
        <div className="splash-delivery-scene relative mb-7 h-[230px] w-full max-w-[340px] animate-in zoom-in-95 duration-700 motion-reduce:animate-none">
          ...
          <div className="splash-category splash-category-drink absolute right-6 top-[112px] text-[#5CA536]">
            <Package size={19} weight="duotone" />
          </div>
          <div className="splash-category splash-category-beauty absolute left-[86px] top-5 text-[#336886]">
            <Sparkle size={19} weight="duotone" />
          </div>
          <div className="splash-category splash-category-bag absolute right-[86px] top-5 text-[#5CA536]">
