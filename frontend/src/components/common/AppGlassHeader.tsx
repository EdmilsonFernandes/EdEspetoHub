...
export function AppGlassHeader({
  ...
  return (
    <header
      className={`fixed inset-x-0 top-0 z-[80] border-b border-white/70 bg-[linear-gradient(180deg,rgba(226,242,250,0.86)_0%,rgba(255,255,255,0.76)_56%,rgba(255,255,255,0.62)_100%)] pt-[env(safe-area-inset-top)] text-[#153A4C] shadow-[0_18px_44px_-34px_rgba(21,58,76,0.48)] backdrop-blur-2xl supports-[backdrop-filter]:bg-white/64 ${className}`}
    >
      {topSlot}
