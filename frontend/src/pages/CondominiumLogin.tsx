    ...
    <AuthLayout>
      <div className="w-full max-w-[560px] space-y-4 ds-login-card-enter">
        <div className="text-center">
          <div className="mx-auto grid h-[4.5rem] w-[4.5rem] place-items-center overflow-hidden rounded-2xl border border-[#336886]/20 bg-white p-0.5 shadow-[0_8px_28px_-8px_rgba(13,79,102,0.28)]">
