...
const guideSections = [
  ...
  },
  {
    ...
    points: [
      ...
      'No app Já no Caminho, entre como lojista ou operador, abra Impressora e toque em Buscar impressoras pareadas.',
      'Quando a impressora aparecer na lista, toque nela para salvar. A partir daí, os pedidos podem imprimir direto pelo app.',
      'Depois de salvar, volte para a fila de pedidos, abra um pedido e faça um teste de impressão antes do horário de pico.',
      'Se a impressão direta não sair boa, demorar ou falhar, use o modo antigo com o RawBT já instalado/configurado no aparelho.',
      'Resumo para o operador: primeiro tente salvar a impressora no app; se não ficar bom, volte para o RawBT como fallback.',
