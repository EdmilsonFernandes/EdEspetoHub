...
apply_env MP_CLIENT_ID "$MP_CLIENT_ID"
apply_env MP_CLIENT_SECRET "$MP_CLIENT_SECRET"
apply_env MP_OAUTH_REDIRECT_URL "$MP_OAUTH_REDIRECT_URL"
apply_env MP_OAUTH_ENCRYPTION_KEY "$MP_OAUTH_ENCRYPTION_KEY"
