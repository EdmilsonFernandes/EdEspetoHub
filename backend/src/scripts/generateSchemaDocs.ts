...
const TABLE_DESCRIPTION_OVERRIDES: Record<string, string> = {
  ...
  order_shipment_events: 'Eventos de rastreio postal vindos da loja, sistema ou transportadora.',
...
const TABLE_RESPONSIBILITY_OVERRIDES: Record<string, string> = {
  ...
  order_shipments: 'Complementa pedidos postais com serviço escolhido, código de rastreio, URL, data de postagem e entrega.',
  order_shipment_events: 'Monta a timeline postal exibida ao cliente, separando eventos do vendedor, sistema e transportadora.',
...
function tableSubject(tableName: string): string {
  const map: Record<string, string> = {
    ...
    order_shipment_events: 'evento de rastreio postal',
