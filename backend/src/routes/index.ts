...
routes.post('/auth/mfa/challenge/verify', authLoginRateLimit, AuthController.verifyMfaChallenge);
routes.get('/auth/mfa/status', requireAuth, AuthController.mfaStatus);
routes.post('/auth/mfa/setup/start', requireAuth, AuthController.startMfaSetup);
routes.post('/auth/mfa/setup/confirm', requireAuth, AuthController.confirmMfaSetup);
routes.post('/auth/mfa/disable', requireAuth, AuthController.disableMfa);
routes.get('/auth/mfa/trusted-devices', requireAuth, AuthController.listTrustedDevices);
...
routes.delete('/admin/condominiums/:condominiumId/stores/:storeId', requireAuth, requireRole('SUPER_ADMIN'), CondominiumController.adminRemoveStore);
...
routes.get('/admin/destinations/:destinationId/banners', requireAuth, requireRole('SUPER_ADMIN'), DestinationController.adminListDestinationBanners);
...
routes.get('/stores/:storeId/dashboard-movement', requireAuth, requireRole('ADMIN', 'OPERATOR', 'LOJISTA'), StoreController.getDashboardMovement);
